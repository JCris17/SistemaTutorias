...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:estudiante'])->group(function () {
        ...
        Route::post('/estudiante/inscribir/{tutoria}', [EstudianteController::class, 'inscribirTutoria'])->name('estudiante.inscribir-tutoria');
        Route::get('/estudiante/inscribirse', [EstudianteController::class, 'inscribirse'])->name('estudiante.inscribirse');
        Route::post('/estudiante/tutorias/{id}/inscribir', [EstudianteController::class, 'inscribirTutoria'])->name('estudiante.tutorias.inscribir');
        Route::delete('/estudiante/tutorias/{id}/cancelar', [EstudianteController::class, 'cancelarTutoria'])->name('estudiante.tutorias.cancelar');
