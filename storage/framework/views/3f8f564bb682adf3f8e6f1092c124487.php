    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('coordinador.dashboard')); ?>">
                            <i class="fas fa-tachometer-alt"></i> Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('coordinador.tutorias')); ?>">
                            <i class="fas fa-chalkboard-teacher"></i> Gestión de Tutorías
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('coordinador.asistencia')); ?>">
                            <i class="fas fa-clipboard-check"></i> Control de Asistencia
                        </a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('coordinador.reportes')); ?>">
                        <i class="fas fa-chart-bar"></i> Reportes
                    </a>
                </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('coordinador.estudiantes')); ?>">
                            <i class="fas fa-user-graduate"></i> Estudiantes
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('coordinador.tutores')); ?>">
        ...
        <div class="main-content">
            ...
            <div class="top-navbar">
                <div>
                    <h4 class="mb-0" id="current-page-title">
                        <?php if(request()->routeIs('coordinador.tutorias')): ?>
                            Gestión de Tutorías
                        <?php elseif(request()->routeIs('coordinador.estudiantes')): ?>
                            Gestión de Estudiantes
                        <?php elseif(request()->routeIs('coordinador.tutores')): ?>
                            Gestión de Tutores
                        <?php elseif(request()->routeIs('coordinador.asistencia')): ?>
                            Control de Asistencia
                        <?php elseif(request()->routeIs('coordinador.reportes')): ?>
                            Reportes
                        <?php else: ?>
                            Dashboard
                        <?php endif; ?>
                ...
                <div class="user-info">
                    <div class="user-avatar"><?php echo e(substr($coordinador->name, 0, 2)); ?></div>
                    <div>
                        <div class="fw-bold"><?php echo e($coordinador->name); ?></div>
            ...
            <div class="content-area">
                <!-- Dashboard Page -->
                <?php if(request()->routeIs('coordinador.dashboard') || request()->routeIs('coordinador')): ?>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3">
                            <div class="card stats-card">
                                ...
                                <div class="stats-number"><?php echo e($tutoriasActivas); ?></div>
                        ...
                        <div class="col-md-3">
                            <div class="card stats-card">
                                ...
                                <div class="stats-number"><?php echo e($totalEstudiantes); ?></div>
                        ...
                        <div class="col-md-3">
                            <div class="card stats-card">
                                ...
                                <div class="stats-number"><?php echo e($totalTutores); ?></div>
                        ...
                        <div class="col-md-3">
                            <div class="card stats-card">
                                ...
                                <div class="stats-number"><?php echo e($asistenciaPromedio); ?>%</div>
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php $__empty_1 = true; $__currentLoopData = $proximasTutorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <?php
                                                    $fechaFormateada = \Carbon\Carbon::parse($tutoria->fecha)->format('d/m/Y H:i');
                                                ?>
                                                <tr>
                                                    <td><?php echo e($tutoria->tema); ?></td>
                                                    <td><?php echo e($tutoria->tutor->name ?? 'Tutor no asignado'); ?></td>
                                                    <td><?php echo e($fechaFormateada); ?></td>
                                                    <td>
                                                        <span class="badge badge-custom 
                                                            <?php echo e($tutoria->estado == 'activa' ? 'badge-success' : 
                                                               ($tutoria->estado == 'pendiente' ? 'badge-warning' : 'badge-danger')); ?>">
                                                            <?php echo e(ucfirst($tutoria->estado)); ?>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-outline-custom btn-ver-detalles-tutoria" 
                                                                ...
                                                                data-tutor="<?php echo e($tutoria->tutor->name ?? 'Tutor no asignado'); ?>"
                                                                data-fecha="<?php echo e($fechaFormateada); ?>"
                                                                data-modalidad="<?php echo e($tutoria->modalidad ?? 'No especificado'); ?>"
                                                                data-estado="<?php echo e($tutoria->estado); ?>"
                                                                data-descripcion="<?php echo e($tutoria->observaciones ?? 'Sin descripción'); ?>">
                                                            Ver Detalles
                                                        </button>
                                                    </td>
                                                </tr>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <?php $__empty_1 = true; $__currentLoopData = $solicitudesPendientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solicitud): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="d-flex align-items-start mb-3">
                                        <div class="flex-shrink-0">
                                            <i class="fas fa-exclamation-triangle text-warning"></i>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <p class="mb-1"><?php echo e($solicitud->tipo ?? 'Solicitud'); ?> - <?php echo e($solicitud->materia ?? 'General'); ?></p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-custom">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo e($tutoria->id); ?></td>
                                            <td><?php echo e($tutoria->tema); ?></td>
                                            <td><?php echo e($tutoria->tutor->name ?? 'Tutor no asignado'); ?></td>
                                            <td><?php echo e($fechaFormateada); ?></td>
                                            <td><?php echo e(ucfirst($tutoria->modalidad)); ?></td>
                                            <td>
                                                <span class="badge badge-custom 
                                                    <?php echo e($tutoria->estado == 'activa' ? 'badge-success' : 
                                                       ($tutoria->estado == 'pendiente' ? 'badge-warning' : 'badge-danger')); ?>">
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-outline-custom me-1 btn-editar-tutoria" 
                                                        ...
                                                        data-tema="<?php echo e($tutoria->tema); ?>"
                                                        data-tutor="<?php echo e($tutoria->id_tutor); ?>"
                                                        data-fecha="<?php echo e($tutoria->fecha); ?>"
                                                        data-hora="<?php echo e($tutoria->hora_inicio); ?>"
                                                        data-modalidad="<?php echo e($tutoria->modalidad); ?>"
                                                        data-estado="<?php echo e($tutoria->estado); ?>"
                                                        data-descripcion="<?php echo e($tutoria->observaciones); ?>">
                                                    Editar
                                                </button>
                                                <?php if($tutoria->estado != 'cancelada'): ?>
                                                <form method="POST" action="<?php echo e(route('coordinador.tutorias.eliminar', $tutoria->id)); ?>" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                ...
                <!-- Asistencia Page -->
                <?php if(request()->routeIs('coordinador.asistencia')): ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="selectTutoria">
                                            ...
                                            <?php $__currentLoopData = $tutorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($tutoria->estado == 'activa' || $tutoria->estado == 'pendiente'): ?>
                                                <?php
                                                    $fechaFormateada = \Carbon\Carbon::parse($tutoria->fecha)->format('d/m/Y H:i');
                                                ?>
                                                <option value="<?php echo e($tutoria->id); ?>">
                                                    <?php echo e($tutoria->tema); ?> - <?php echo e($fechaFormateada); ?> (<?php echo e($tutoria->tutor->name ?? 'Sin tutor'); ?>)
                                                </option>
                                                <?php endif; ?>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    ?>
                                    <div class="mb-4">
                                        <h3 class="text-primary"><?php echo e($asistenciaPromedio); ?>%</h3>
                                        <p class="text-muted">Asistencia General</p>
                                    </div>
                                    <div class="d-flex justify-content-around mb-3">
                                        <div>
                                            <h5 class="text-success"><?php echo e($asistenciasPresente); ?></h5>
                                            <small>Presentes</small>
                                        </div>
                                        <div>
                                            <h5 class="text-danger"><?php echo e($totalAsistencias - $asistenciasPresente); ?></h5>
                                            <small>Ausentes</small>
                                        </div>
                                    </div>
                                    <div class="progress mb-3" style="height: 10px;">
                                        <div class="progress-bar bg-success" style="width: <?php echo e($asistenciaPromedio); ?>%"></div>
                                    </div>
                                    <small class="text-muted">Basado en <?php echo e($totalAsistencias); ?> registros</small>
                                </div>
                            </div>
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    <?php $__currentLoopData = $tutorias->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div>
                                            <small class="fw-bold"><?php echo e($tutoria->tema); ?></small>
                                            <br>
                                            <small class="text-muted">
                                                <?php echo e(\Carbon\Carbon::parse($tutoria->fecha)->format('d/m/Y')); ?>

                                            </small>
                                        </div>
                                        <span class="badge badge-custom <?php echo e($tutoria->estado == 'activa' ? 'badge-success' : 'badge-warning'); ?>">
                                            <?php echo e(ucfirst($tutoria->estado)); ?>
                ...
                <!-- Estudiantes Page -->
                <?php if(request()->routeIs('coordinador.estudiantes')): ?>
                                ...
                                <table class="table table-hover table-custom">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($estudiante->carrera ?? 'No especificada'); ?></td>
                                            <td>
                                                <span class="badge badge-custom <?php echo e($estudiante->activo ? 'badge-success' : 'badge-danger'); ?>">
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-outline-custom btn-ver-detalles-estudiante"
                                                        data-nombre="<?php echo e($estudiante->name); ?>"
                                                        data-email="<?php echo e($estudiante->email); ?>"
                                                        data-carrera="<?php echo e($estudiante->carrera ?? 'No especificada'); ?>"
                                                        data-estado="<?php echo e($estudiante->activo ? 'Activo' : 'Inactivo'); ?>">
                                                    Ver Detalles
                                                </button>
                                            </td>
                                        </tr>
                ...
                <!-- Tutores Page -->
                <?php if(request()->routeIs('coordinador.tutores')): ?>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-custom">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $tutores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e($tutor->id); ?></td>
                                            <td><?php echo e($tutor->name); ?></td>
                                            <td><?php echo e($tutor->email); ?></td>
                                            <td><?php echo e($tutor->especialidad ?? 'No especificada'); ?></td>
                                            <td>
                                                <span class="badge badge-custom <?php echo e($tutor->activo ? 'badge-success' : 'badge-danger'); ?>">
                                                    <?php echo e($tutor->activo ? 'Activo' : 'Inactivo'); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-outline-custom btn-ver-detalles-tutor"
                                                        data-nombre="<?php echo e($tutor->name); ?>"
                                                        data-email="<?php echo e($tutor->email); ?>"
                                                        data-especialidad="<?php echo e($tutor->especialidad ?? 'No especificada'); ?>"
                                                        data-estado="<?php echo e($tutor->activo ? 'Activo' : 'Inactivo'); ?>">
                                                    Ver Detalles
                                                </button>
                                            </td>
                                        </tr>
                ...
                <!-- Reportes Page -->
                <?php if(request()->routeIs('coordinador.reportes')): ?>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="form-generar-reporte" method="POST" action="<?php echo e(route('coordinador.reportes.generar')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="d-flex justify-content-between">
                                                    <span>Activas:</span>
                                                    <span class="fw-bold text-success"><?php echo e($tutoriasActivasCount); ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="d-flex justify-content-between">
                                                    <span>Pendientes:</span>
                                                    <span class="fw-bold text-warning"><?php echo e($tutoriasPendientesCount); ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="d-flex justify-content-between">
                                                    <span>Canceladas:</span>
                                                    <span class="fw-bold text-danger"><?php echo e($tutoriasCanceladasCount); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="crearTutoriaModal" tabindex="-1" aria-labelledby="crearTutoriaModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('coordinador.tutorias.crear')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="crearEstudianteModal" tabindex="-1" aria-labelledby="crearEstudianteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('coordinador.estudiantes.crear')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="crearTutorModal" tabindex="-1" aria-labelledby="crearTutorModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('coordinador.tutores.crear')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="name" class="form-label">Nombre Completo</label>
...
document.getElementById('selectTutoria')?.addEventListener('change', function() {
    ...
    if (tutoriaId) {
        ...
        document.getElementById('btn-guardar-asistencia')?.addEventListener('click', function() {
            ...
            fetch('<?php echo e(route("coordinador.asistencia.registrar")); ?>', {
                method: 'POST',
                body: formData
            })
            .then(response => response.json())
...
</html><?php /**PATH C:\Users\Flia. Vera Soria\tutorias_isi\resources\views/coordinador.blade.php ENDPATH**/ ?>